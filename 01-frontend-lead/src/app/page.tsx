...
const FEATURES = [
  ...
  },
  {
    ...
    text: "Designed around how Rwandan farmers and buyers already work together.",
  },
];
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Rwandan farmers working together in the field"
            fill
            priority
            sizes="100vw"
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col items-start justify-center px-4 py-28 sm:px-6 md:py-40">
          <span className="mb-5 inline-flex items-center gap-2 rounded-full bg-white/15 px-3 py-1 text-xs font-semibold text-white backdrop-blur">
            ...
            Built for Rwandan farmers, made simple
          </span>
          ...
          <p className="mt-6 max-w-xl text-lg leading-relaxed text-white/85">
            AgriFlow connects Rwandan farmers and buyers. Post your produce,
            agree a fair price, and get paid securely through Mobile Money the
            moment your delivery is confirmed.
          </p>
      ...
      <section id="how" className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {STEPS.map((step, i) => (
            ...
            >
              <span className="absolute right-5 top-5 text-4xl font-black text-black/5">
                0{i + 1}
              </span>
              <div className="mb-5 grid h-14 w-14 place-items-center rounded-2xl bg-[#e3f1e8] text-2xl">
                {step.icon}
              </div>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {PRODUCTS.map((p) => (
              <div
                key={p.name}
                className="rounded-2xl border border-black/5 bg-[#fafbf9] p-6 transition hover:border-[#1f7a4d]/30 hover:shadow-md"
              >
                <div className="grid h-14 w-14 place-items-center rounded-2xl bg-[#e3f1e8] text-2xl">
                  {p.emoji}
                </div>
        ...
        <div className="grid items-center gap-10 md:grid-cols-2">
          <div className="relative h-72 overflow-hidden rounded-3xl md:h-96">
            <Image
              ...
              alt="Fresh harvest ready to sell"
              fill
          ...
          <div>
            ...
            <p className="mt-4 text-[#54705f]">
              Browse fresh produce posted by farmers across Rwanda, compare
              prices, and make an offer in seconds. Farmers see every offer and
